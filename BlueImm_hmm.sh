...
#locate DUF5079 gene sequences in the current strain
hmmbuild DUF5079.hmm BlueImm_aln.fasta
...
#locate DUF5079 gene sequences in the current strain
nhmmer --tblout ${strain[index]}_DUF5079.tblout DUF5079.hmm ${assembly[index]}.gb

#extract all DUF5079-like sequences with an E-value < 1.0e-100
grep -v "^#" ${strain[index]}_DUF5079.tblout | awk '{if ($13 < 1.0e-100){print $1"/"$9"-"$10, $9, $10, $1}}' | esl-sfetch -Cf ${assembly[index]}.gb - > ${strain[index]}_DUF5079.fa

#add in turn each DUF5079-like sequence to a fasta file
cat ${strain[index]}_DUF5079.fa >> DUF5079_all.fa
